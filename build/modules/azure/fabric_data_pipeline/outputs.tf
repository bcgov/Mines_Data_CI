...
output "run_rest_command" {
  ...
  value       = "curl -X POST -H 'Authorization: Bearer $TOKEN' 'https://api.fabric.microsoft.com/v1/workspaces/${var.workspace_id}/items/${try(fabric_data_pipeline.this[0].id, "")}/jobs/instances?jobType=Pipeline'"
}
